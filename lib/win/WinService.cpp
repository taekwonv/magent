...
#define SERVICENAME	L"magent"
#define SERVICEDISPLAYNAME	L"magent for windows"
...
bool WinService::CreateService(const wstring &binPath, const wstring &cfgPath)
{
